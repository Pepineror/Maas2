...
class RedmineProject(BaseSchema):
...
class RedmineIssue(BaseSchema):
    ...
    start_date: Optional[str] = Field(None, description="Start date (YYYY-MM-DD)") # Redmine uses simple date strings for these
