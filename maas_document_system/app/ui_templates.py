...
from maas_document_system.schemas.template_contracts import DocumentTemplate, TemplateMetadata, TemplateSection

logging.basicConfig(level=logging.INFO)
logger = logging.getLogger(__name__)

# Resolving path relative to this file
# This file is in maas_document_system/app/
# knowledge is in maas_document_system/knowledge/
